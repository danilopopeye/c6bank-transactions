...
- [x] 1.3 Test `ParseFile` with each supported format (CSV, PNG) and error cases
- [x] 1.4 Test `Deduplicate` with overlapping and non-overlapping transactions
...
- [x] 2.4 Test CLI main with no args, single file, and multiple files
